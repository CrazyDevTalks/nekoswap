    ...
    <>
      ...
      >
        ...
        >
          ...
          <p className="text-[#fff] text-[19.067px] font-bold">TaikoPad</p>
        </Link>
        ...
        <div className="flex justify-center items-center">
          ...
          >
            <button
              className={`mt-[34px] px-6 py-3 flex justify-center items-center gap-2 rounded-[39px] h-[43px] bg-[#C03F4A]`}
            >
              <p
