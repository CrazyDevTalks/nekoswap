        ...
        <div className="pt-4 px-5 pb-5">
          ...
          <div className="flex flex-col mt-6 gap-2">
            ...
            <div className="bg-[#2C2C2C] rounded-[150px] w-[326px] h-[12px] relative">
              <div className="absolute bg-[#C03F4A] rounded-[150px] h-[12px] w-[173px]"></div>
            </div>

            <div className="flex justify-between">
              <p className="text-[#86888c] text-[14px]">90.339ETH</p>
              <p className="text-[#C03F4A] text-[14px]">0.5ETH</p>
            </div>
          </div>
          ...
          <div className="flex justify-between mt-4">
            ...
            <div className="flex gap-2 items-center">
              ...
              >
                <span className="text-[#C03F4A]"> View </span>
              </div>
            </div>
          </div>
        </div>
